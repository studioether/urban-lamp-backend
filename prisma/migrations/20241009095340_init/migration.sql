...
-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_bookmarkedByUser_fkey" FOREIGN KEY ("bookmarkedByUser") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
